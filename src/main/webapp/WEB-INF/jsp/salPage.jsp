    ...
    <div class="hrms_dept_body">
        ...
        <div class="sal_info col-sm-10">
            <div class="panel panel-success">
                ...
                <!-- Table -->
                <table class="table table-bordered table-hover" id="sal_table">
                    <thead>
                    <th>工资发放编号编号</th>
                    <th>员工姓名</th>
                    <th>应发工资</th>
                    ...
                    <c:forEach items="${sal}" var="sal">
                        <tr>
                            ...
                            <td>${sal.paytime}</td>
                            <td>
                                <a href="#" role="button" class="btn btn-primary dept_edit_btn" data-toggle="modal" data-target=".emp-add-modal">编辑</a>
                ...
                <div class="panel-body">
                    ...
                    <nav aria-label="Page navigation" class="pull-right">
                        <ul class="pagination">
                            <li><a href="/hrms/sal/getSalList?pageNo=1">首页</a></li>
                            ...
                            <c:forEach begin="1" end="${totalPages<5?totalPages:5}" step="1" var="itemPage">
                                <c:if test="${curPageNo == itemPage}">
                                    <li class="active"><a href="/hrms/sal/getSalList?pageNo=${itemPage}">${itemPage}</a></li>
                                </c:if>
                                <c:if test="${curPageNo != itemPage}">
                                    <li><a href="/hrms/sal/getSalList?pageNo=${itemPage}">${itemPage}</a></li>
                                </c:if>
                            </c:forEach>
                            ...
                            <li><a href="/hrms/sal/getSalList?pageNo=${totalPages}">尾页</a></li>
                        </ul>
                    </nav>
                </div>
...
<script type="text/javascript">
    ...
    $(".prePage").click(function () {
        if (curPageNo > 1){
            ...
            $(this).attr("href", "/hrms/sal/getSalList/?pageNo="+pageNo);
        }
    });
    //下一页
        ...
        if (confirm("确认删除【"+ delDeptName +"】的信息吗？")){
            $.ajax({
                ...
                success:function (result) {
                    if (result.code == 100){
                        alert("删除成功！");
                        window.location.href = "/hrms/sal/getSalList?pageNo="+curPageNo;
                    }else {
